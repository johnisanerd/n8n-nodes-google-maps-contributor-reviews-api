...
import { ACTOR_ID } from '../ApifyMapsContributorReviews.node';
import { buildActorInput } from '../ApifyMapsContributorReviews.properties';
...
function shapeItem(
	...
	// simplified
	const place = (item.place_info ?? {}) as Record<string, any>;
	return {
