...
import { properties } from './ApifyMapsContributorReviews.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = 'ZtBuxIbU7gPdQozq3' as string;

export const PACKAGE_NAME = 'n8n-nodes-google-maps-contributor-reviews-api' as string;
export const CLASS_NAME = 'ApifyMapsContributorReviews' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'google-maps-contributor-reviews-app' as string;

export const DISPLAY_NAME = 'Google Maps Contributor Reviews' as string;
export const DESCRIPTION =
	'Get all reviews written by a Google Maps contributor, with ratings, places, and dates' as string;

export class ApifyMapsContributorReviews implements INodeType {
